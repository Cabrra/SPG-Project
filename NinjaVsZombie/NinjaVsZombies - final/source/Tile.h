...
public:
	enum m_eTiletype{ walkable = 1, collidable, hole, trigger, firetrap, electrictrap, spiketrap, faketrap, spawntrap, door };
	...
	//void				SetType(m_eTiletype newtype)	const	{ type = newtype; }
